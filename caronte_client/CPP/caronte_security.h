...
namespace CaronteSecurity{
	 ...
	 * @return Base64 encoded string
	 */
	char* toB64Bytes(const unsigned char* data, size_t len);
	 ...
	 */
	char* fromB64Str(const char* data);
	 ...
	 */
	unsigned char* fromB64Bytes(const char* data, size_t& len);
	 ...
	 */
	unsigned char* pad(const unsigned char* data, size_t len, size_t* new_len, size_t block_size);
	 ...
	 */
	unsigned char* unpad(const unsigned char* data, size_t len, size_t* new_len);
	 ...
	 */
	char* generate128Hash(const char* text);
	 ...
	 */
	char* generate256Hash(const char* text);
	 ...
	 */
	char* deriveText(const char* text, const char* IV, size_t iters);
	 ...
	 */
	int verifyDerivedText(const char* text, const char* derivedtext, const char* IV, size_t iters);
	 ...
	 * @return ciphertext
	 */
	char* encryptKey(const char* key, const unsigned char* plaintext, size_t len, const char* IV);
	 ...
	 * @return plaintext
	 */
	unsigned char* decryptKey(const char* key, const char* ciphertext, size_t* len, const char* IV);
	 ...
	 * @return ciphertext
	 */
	char* encryptPBE(const char* password, const unsigned char* plaintext, size_t len, const char* IV);
	 ...
	 * @return plaintext
	 */
	unsigned char* decryptPBE(const char* password, const char* ciphertext, size_t* len, const char* IV);
